    ...
    <div className="container mx-auto p-4">
      ...
      <div className="bg-white dark:bg-gray-800 border rounded-lg shadow-lg p-6 mb-8">
        ...
        <table className="table-auto w-full text-gray-700 dark:text-gray-300 text-center">
          ...
          <tbody>
            <tr>
              <td className="px-4 py-2 border">BCA</td>
              <td className="px-4 py-2 border">bca-101</td>
            ...
            <tr>
              <td className="px-4 py-2 border">MCA</td>
              <td className="px-4 py-2 border">mca-201</td>
              <td className="px-4 py-2 border">
                <a
