...
export default function BuisnessAdmin() {
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="w-full mb-6">
        <img
          src="/b.jpg" 
          alt="Business Adminstration Department"
          className="w-full h-auto rounded-lg shadow-lg"
        />
      </div>


      <div className="flex flex-col lg:flex-row gap-6 mb-8 text-center">
      ...
      <div className="bg-white dark:bg-gray-800 border rounded-lg shadow-lg p-6 mb-8">
        ...
        <table className="table-auto w-full text-gray-700 dark:text-gray-300 text-center">
          ...
          <tbody>
            <tr>
              <td className="px-4 py-2 border">BBA</td>
              <td className="px-4 py-2 border">bba-101</td>
            ...
            <tr>
              <td className="px-4 py-2 border">MBA</td>
              <td className="px-4 py-2 border">mba-201</td>
              <td className="px-4 py-2 border">
                <a
